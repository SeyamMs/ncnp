                ...
                >
                    <div class="lg:gap-2 flex items-center gap-1">
                        <button
                            ...
                            x-data
                            x-on:click.prevent="$scroll('#about-section', {behavior: 'smooth', offset: '100px'})"
                        >
                            عن التحدي
                        </button>
                        ...
                        <button
                            class="md:text-sm flex-shrink-0 p-2 text-xs font-medium text-white"
                            x-data
                            x-on:click.prevent="$scroll('#paths-section', {behavior: 'smooth', offset: '100px'})"
                        >
                            المسارات
                        </button>
                        <span class="md:block flex-shrink-0 hidden w-px h-4 bg-gray-100"></span>
                        <button
                            class="md:text-sm flex-shrink-0 p-2 text-xs font-medium text-white"
                            x-data
                            x-on:click.prevent="$scroll('#targets-section', {behavior: 'smooth', offset: '100px'})"
                        >
                            الفئة المستهدفة
                        </button>
                        <span class="md:block flex-shrink-0 hidden w-px h-4 bg-gray-100"></span>
                        <button
                            ...
                            x-data
                            x-on:click.prevent="$scroll('#timeline-section', {behavior: 'smooth', offset: '100px'})"
                        >
                            رحلة التحدي ومراحله
                        </button>
                        <span class="md:block flex-shrink-0 hidden w-px h-4 bg-gray-100"></span>
                        <button
                            class="md:text-sm sm:block flex-shrink-0 hidden p-2 text-xs font-medium text-white"
                            x-data
                            x-on:click.prevent="$scroll('#prizes-section', {behavior: 'smooth', offset: '100px'})"
                        >
                            الخارطة
                        </button>
                        <span class="md:block flex-shrink-0 hidden w-px h-4 bg-gray-100"></span>
